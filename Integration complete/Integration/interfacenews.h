...
private slots:
   ...
   void on_activer_moteur_2_clicked();

    void on_desactiver_moteur_clicked();
   ...
   void on_pb_ajouter_clicked();
    ...
    void on_tab_musique_2_activated(const QModelIndex &index);

    void on_temp_ajout_clicked();

    void on_temp_refresh_clicked();
